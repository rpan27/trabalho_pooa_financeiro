 ...
 * @author ronny
 */
public class CallViewListaUsuarioAction implements ICommanderAction{
    ...
    public void executar(HttpServletRequest request, HttpServletResponse response) throws Exception {
        RequestDispatcher rd = request.getRequestDispatcher("template.jsp?page=lstUsuario");    
           
           List<UsuarioViewDTO> usuarios = new UsuarioDAO().getSearchUsuarios("");
